function initPage() {
  ...
  const searchCityEl = document.getElementById("search-button");
  const clearSearchEl = document.getElementById("clear-history");
  const nameEl = document.getElementById("city-name");
  const currentPictureEl = document.getElementById("current-pic");
  const currentTempeEl = document.getElementById("temperature");
  ...
  function getWeather(cityName) {
    ...
    axios.get(queryURL).then(function (response) {
      ...
      axios.get(UVQueryURL).then(function (response) {
        ...
        currentUVIndexEl.append(UVIndex);
      });
  ...
  searchCityEl.addEventListener("click", function () {
    const searchTerm = inputCityEl.value;
